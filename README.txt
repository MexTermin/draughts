...
eating (capturing) the pieces of the opposing player passing over those pieces.
...
Rules:
	...
	- If the adjacent square contains an opponent's piece, and the square immediately beyond
    it is vacant, the piece may be eated (and removed from the game) by jumping over it.
